    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#table-datatable').DataTable({
                ...
                ajax: '{!! route('configuration.prompt.datatable') !!}',
                "processing": true,
                "serverSide": true,
                columns: [{
                        data: 'id',
...
@section('content')
                ...
                <div class="dt-action-buttons text-start pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                            ...
                            <span class="d-none d-sm-inline-block">Ajouter une prompt</span>
                        </button>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasAddRecord" aria-labelledby="offcanvasAddRecordLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasAddRecordLabel" class="offcanvas-title">Ajouter une prompt</h5>
        ...
        <div class="offcanvas-body mx-0 flex-grow-0">
            <form class="add-new-record pt-0 row g-2" id="form-add-new-record">
                ...
                <div class="col-sm-12 mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="type2" class="input-group-text"><i class="ti ti-quote"></i></span>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasEditRecord"
        ...
        <div class="offcanvas-header">
            <h5 id="offcanvasEditRecordLabel" class="offcanvas-title">Modifier une prompt</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body mx-0 flex-grow-0">
            <form class="edit-record pt-0 row g-2" id="form-update-record">
                ...
                <div class="col-sm-12 mb-3">
                    <label class="form-label" for="type-edit">Type</label>
                    <div class="input-group input-group-merge">
                        <span id="type-edit2" class="input-group-text"><i id="type-edit3"
                                class="ti ti-quote"></i></span>
                        <input type="text" id="type-edit" class="form-control" name="type" placeholder="Type"
                            required />
                    </div>
                </div>
                <div class="col-sm-12 mb-3">

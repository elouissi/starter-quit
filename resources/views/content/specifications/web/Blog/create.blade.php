...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/form-wizard-validation-w-b.js') }}"></script>
    <script>
...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Cahier des charges/</span> Web / Blog
    </h4>
    <!-- Default -->
    <div class="row">
                                                ...
                                                <div class="row">
                                                    @foreach ($project_needs as $item)
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    id="blog" name="project_type"checked
                                                                    value="Blog">
                                                                <label class="form-check-label"
                                                                    for="blog">
                                                                    Blog</label>

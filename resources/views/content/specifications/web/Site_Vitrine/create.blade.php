...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/form-wizard-validation-w-v.js') }}"></script>
    <script>
...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Créer un cahier des charges/</span> Web / Site Vitrine
    </h4>
    <!-- Default -->
    <div class="row">
                                                ...
                                                <div class="row">
                                                    @foreach ($project_needs as $item)
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    id="siteVitrine" name="project_type"checked
                                                                    value="Site Vitrine">
                                                                <label class="form-check-label"
                                                                    for="siteVitrine">
                                                                    Site Vitrine</label>

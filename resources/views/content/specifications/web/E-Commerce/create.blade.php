...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/form-wizard-validation-w-e.js') }}"></script>
    <script>
...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Cahier des charges/</span> Web / E-Commerce
    </h4>
    <!-- Default -->
    <div class="row">
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" checked
                                                                    id="eCommerce" name="project_type"
                                                                    value="E-commerce">
                                                                <label class="form-check-label"
                                                                    for="eCommerce">
                                                                    E-commerce</label>

...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/form-wizard-validation-m-e.js') }}"></script>
    <script>
            ...
            $('#next-step-3').on('click', function() {
                ...
                if (concurrents) {
                    $('#iatext_competitorsAi').val(
                        `voici les concurrents (${concurrents}), étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi deux paragraphe sur l’analyse des principaux concurrents et identification des points forts à intégrer sur l'application mobile que le client souhaite`
                    ).prop('title',
                        `voici les concurrents (${concurrents}), étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi deux paragraphe sur l’analyse des principaux concurrents et identification des points forts à intégrer sur l'application mobile que le client souhaite`
                    ).trigger('input');
                } else {
...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Cahier des charges/</span> Mobile / App E-Commerce
    </h4>
    <!-- Default -->
    <div class="row">
                                ...
                                <div class="row g-3 validation-field">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-10 mb-3">
                                                ...
                                                @php
                                                    $project_needs = [
                                                        ...
                                                        ['name' => 'App E-commerce', 'alias' => 'App-eCommerce'],
                                            ...
                                            <div class="col-10 mb-3">
                                                <label class="form-label" for="menu">
                                                    Mots-clés cibles (Avez-vous des mots-clés spécifiques à cibler sur l'application) :
                                                </label>
                                                <textarea class="form-control" name="target_keywords" rows="3" id="target_keywords"
                                                    placeholder="Saisissez vos mots-clés cibles pour l'application"></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                <label class="form-label" for="menu">
                                                    Menu (Avez vous une préférence des menus à ajouter sur l'application) : <span
                                                        class="text-danger">*</span>
                                                </label>
                                                <textarea class="form-control" id="menu" name="menu" rows="3"
                                                    placeholder="Indiquez votre préférence des menus à ajouter sur l'application"></textarea>
                                            </div>
                                            <div class="col-12 mb-3 d-none ai-content">
                                        ...
                                        <div class="row">
                                            <div class="col-10 mb-3 d-none ">
                                                <label class="form-label" for="concurrents">
                                                   application mobile de vos principaux concurrents : <span
                                                        class="text-danger">*</span>
                                                </label>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="exemples-sites" class="form-control" name="exemples_sites" rows="3"
                                                            placeholder="Ajoutez des exemples des applications mobile que vous aimez avec des commentaires sur ce que vous aimez bien sur ces applications mobile (éléments, animation, couleurs, architecture d’informations, fonctionnalités, etc.)."></textarea>
                                                    </div>

...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Modifier un cahiers de charges/</span> Mobile / E-Commerce
    </h4>
    <!-- Default -->
    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-10 mb-3">
                                                ...
                                                <input type="text" name="entreprise_name" id="nomEntreprise"
                                                    ...
                                                    value="{{ $specification->entreprise_name }}" />
                                            </div>
                                            ...
                                            <div id="websiteInput"
                                                ...
                                                <input type="text" name="website_domaine" id="website"
                                                    ...
                                                    value="{{ $specification->website_domaine }}" />
                                            </div>
                                            <div class="col-10 mb-3">
                                                ...
                                                <input type="text" name="contact_person" id="personneContacte"
                                                    class="form-control" value="{{ $specification->contact_person }}"
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                ...
                                                <input type="tel" name="phone" id="telephone" class="form-control"
                                                    ...
                                                    value="{{ $specification->phone }}" />
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label class="form-label" for="email">Email <span
                                                        class="text-danger">*</span></label>
                                                <input type="email" name="email" id="email" class="form-control"
                                                    placeholder="Adresse email" value="{{ $specification->email }}" />
                                            </div>
                                            <div class="col-12 mb-3">
                                            ...
                                            <div class="col-12 mb-3 d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control" name="prompt_description"
                                                        ...
                                                        value="{{ $specification->prompt_description }}">
                                            ...
                                            <div class="col-12 mb-3  d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control" readonly
                                                        ...
                                                        value="{{ $specification->prompt_main_activities }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                            ...
                                            <div class="col-12 mb-3  d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $specification->prompt_services_products }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                            ...
                                            <div class="col-12 mb-3  d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $specification->prompt_target_audience }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                                ...
                                                <textarea name="iatext_target_audience" id="target_audience" class="form-control" rows="3"
                                                    placeholder="Activité principale de l'entreprise" readonly>{{ $specification->iatext_target_audience }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-3 validation-field">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    value="{{ $item['name'] }}"
                                                                    {{ isset($specification->objectif_site->project_need) && $specification->objectif_site->project_need == $item['name'] ? 'checked' : '' }}>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    value="{{ $item['name'] }}"
                                                                    {{ isset($specification->objectif_site->project_type) && $specification->objectif_site->project_type == $item['name'] ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="{{ $item['alias'] }}">
                                                                    {{ $item['name'] }}</label>
                                                            </div>
                                            ...
                                            <div class="col-12 mb-3 {{ isset($specification->objectif_site->project_type) && $specification->objectif_site->project_type == 'E-commerce' ? '' : 'd-none' }}"
                                                id="options-paiement-container">
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    {{ isset($specification->objectif_site->payment_options) && !is_null($specification->objectif_site->payment_options) && in_array($item['name'], $specification->objectif_site->payment_options) ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                            ...
                                            <div class="col-10 mb-3  d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ isset($specification->objectif_site->prompt_iatext_target_keywords) ? $specification->objectif_site->prompt_iatext_target_keywords : '' }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                                        type="button" id="iatext_target_keywordsAi-generate" disabled>
                                                        <i class="ti ti-file-text-ai"></i> &nbsp; Générer
                                                    </button>
                                                </div>
                                                <textarea name="iatext_target_keywords" id="iatext_target_keywords" class="form-control" rows="3" readonly>{{ isset($specification->objectif_site->iatext_target_keywords) ? $specification->objectif_site->iatext_target_keywords : '' }}</textarea>
                                            </div>
                                            <div class="col-10 mb-3">
                                            ...
                                            <div class="col-10 mb-3  d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ isset($specification->objectif_site->prompt_expected_client_objectives) ? $specification->objectif_site->prompt_expected_client_objectives : '' }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                                ...
                                                <textarea name="iatext_expected_client_objectives" id="expectedObjectives" class="form-control" rows="3"
                                                    readonly placeholder="Activité principale de l'entreprise">{{ isset($specification->objectif_site->iatext_expected_client_objectives) ? $specification->objectif_site->iatext_expected_client_objectives : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    value="{{ $item->name }}"
                                                                    {{ isset($specification->objectif_site->expected_functions) && !is_null($specification->objectif_site->expected_functions) && in_array($item['name'], $specification->objectif_site->expected_functions) ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                                    for="{{ $item->alias }}">
                                                                    {{ $item->name }}
                                                                </label>
                                            ...
                                            <div class="col-12 mb-3 d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control" name="prompt_iatext_menu"
                                                        ...
                                                        value="{{ isset($specification->objectif_site->prompt_iatext_menu) ? $specification->objectif_site->prompt_iatext_menu : '' }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                                        type="button" id="iatext_menuAi-generate" disabled>
                                                        <i class="ti ti-file-text-ai"></i> &nbsp; Générer
                                                    </button>
                                                </div>
                                                <textarea name="iatext_menu" id="iatext_menu" class="form-control" rows="3" readonly>{{ isset($specification->objectif_site->iatext_menu) ? $specification->objectif_site->iatext_menu : '' }}</textarea>
                                            </div>
                                            <div class="col-12 mb-3">
                                            ...
                                            <div class="col-12 mb-3 d-none ai-content">
                                                ...
                                                <div class="input-group mb-1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ isset($specification->objectif_site->prompt_iatext_techniques_specs) ? $specification->objectif_site->prompt_iatext_techniques_specs : '' }}">
                                                    <button class="btn btn-outline-primary ai-generate-button"
                                                ...
                                                <textarea name="iatext_techniques_specs" id="iatext_techniques_specs" class="form-control" rows="3" readonly
                                                    placeholder="Activité principale de l'entreprise">{{ isset($specification->objectif_site->iatext_techniques_specs) ? $specification->objectif_site->iatext_techniques_specs : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 d-flex justify-content-between">

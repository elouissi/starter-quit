...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/form-wizard-validation-m-l.js') }}"></script>
    <script>
                ...
                if (1) {
                    ...
                    if (nomEntreprise) {
                        $('#descriptionEntrepriseAi').val(
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur description de ce client: ${nomEntreprise}`
                        ).prop('title',
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur description de ce client: ${nomEntreprise}`
                        ).trigger('input');

                        $('#activitePrincipaleAi').val(
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur l’activité de ce client: ${nomEntreprise}`
                        ).prop('title',
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur l’activité de ce client: ${nomEntreprise}`
                        ).trigger('input');

                        $('#servicesProduitsAi').val(
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur les services ou les produits vendu de ce client: ${nomEntreprise}`
                        ).prop('title',
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur les services ou les produits vendu de ce client: ${nomEntreprise}`
                        ).trigger('input');

                        $('#target_audienceAi').val(
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur le public cible de ce client : ${nomEntreprise}`
                        ).prop('title',
                            `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi un paragraphe sur le public cible de ce client : ${nomEntreprise}`
                        ).trigger('input');
                    } else {
            ...
            $('#next-step-2').on('click', function() {
                ...
                if (objectifsAttendus) {
                    $('#expectedObjectivesAi').val(
                        `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, les objectifs : (${objectifsAttendus}), réécrire moi un paragraphe sur les objectifs attendu de ce client`
                    ).prop('title',
                        `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, les objectifs : (${objectifsAttendus}), réécrire moi un paragraphe sur les objectifs attendu de ce client`
                    ).trigger('input');
                } else {
  ...
  charge de son application mobile à envoyer au client merci d'élaborer cette phrase dans deux
  ...
  paragraphes : (${target_keywords})`
            ...
            $('#next-step-2').on('click', function() {
                ...
                if (menu) {
                    ...
                    console.log(
                        `à partir de cette liste de menu : [${menu}], rédiger et designer moi une sitemap (arborescence) pour une application mobile [${project_type}] de [${servicesProduits}]`
                    );
                    $('#iatext_menuAi').val(
                        `à partir de cette liste de menu : [${menu}], rédiger et designer moi une sitemap (arborescence) pour une application mobile [${project_type}] de [${servicesProduits}]`
                    ).prop('title',
            ...
            $('#next-step-2').on('click', function() {
                ...
                console.log(
                    `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, récrire moi en 3 paragraphes les spécifications techniques (${techniques_specs}) que le client souhaite avoir sur son site`
                );
                if (techniques_specs) {
            ...
            $('#next-step-3').on('click', function() {
                ...
                if (concurrents) {
                    $('#iatext_competitorsAi').val(
                        `voici les concurrents (${concurrents}), étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi deux paragraphe sur l’analyse des principaux concurrents et identification des points forts à intégrer sur une application mobile internet que le client souhaite`
                    ).prop('title',
                        `voici les concurrents (${concurrents}), étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, écrire moi deux paragraphe sur l’analyse des principaux concurrents et identification des points forts à intégrer sur une application mobile internet que le client souhaite`
                    ).trigger('input');
                } else {
...
site internet sur le cahier de charge de sone application mobile`
                );
                if (exemples_sites) {
                    $('#iatext_exemples_sitesAi').val(
                        `écrire un paragraphe détaillé pour élaborer Les éléments suivants (${exemples_sites}) que le client voulait inclure sur le
site internet sur le cahier de charge de son application mobile`
                    ).prop('title',
                        `écrire un paragraphe détaillé pour élaborer Les éléments suivants (${exemples_sites}) que le client voulait inclure sur le
site internet sur le cahier de charge de son application mobile`
                    ).trigger('input');
            ...
            $('#next-step-3').on('click', function() {
                ...
                console.log(
                    `étant qu’expert en rédaction des cahiers des charges pour le développement d’une application mobile, récrire moi en 3 paragraphes les spécifications techniques (${contraintes}) que le client souhaite avoir sur son site`
                );
                if (contraintes) {
...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Cahier des charges/</span> Mobile / App E-Learning
    </h4>
    <!-- Default -->
    <div class="row">
                    ...
                    <div class="step" data-target="#step-2-validation">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                <span class="bs-stepper-title">Objectif <br> du l'application</span>
                            </span>
                        </button>
                    </div>
                    <div class="line">
                ...
                <div class="bs-stepper-content">
                    <div id="wizard-validation-form">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-10 mb-3" style="display: none;" >
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" checked type="radio" name="has_website"
                        ...
                        <div id="step-2-validation" class="content">
                            <div class="content-header mb-3">
                                <h6 class="mb-0 d-none ">Objectifs du site</h6>
                            </div>
                                ...
                                <div class="row g-3 validation-field">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-10 mb-3 d-none ">
                                            ...
                                            <div class="col-10 mb-3">
                                                ...
                                                @php
                                                    $project_needs = [
                                                        ['name' => 'App E-Learning', 'alias' => 'App-E-Learning'],
                                                ...
                                                <div class="row">
                                                    @foreach ($project_needs as $item)
                                                        <div class="col-auto">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    id="{{ $item['alias'] }}" name="project_type" checked
                                                                    value="{{ $item['name'] }}">
                                                                <label class="form-check-label"
                                                                    for="{{ $item['alias'] }}">
                                                                    {{ $item['name'] }}</label>
                                            ...
                                            <div class="col-10 mb-3">
                                                ...
                                                <textarea class="form-control" name="target_keywords" rows="3" id="target_keywords"
                                                    placeholder="Saisissez vos mots-clés cibles pour une application mobile"></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                <label class="form-label" for="menu">
                                                    Menu (Avez vous une préférence des menus à ajouter sur une application mobile) : <span
                                                        class="text-danger">*</span>
                                                </label>
                                                <textarea class="form-control" id="menu" name="menu" rows="3"
                                                    placeholder="Indiquez votre préférence des menus à ajouter une application mobile"></textarea>
                                            </div>
                                            <div class="col-12 mb-3 d-none ai-content">
                                        ...
                                        <div class="row">
                                            <div class="col-10 mb-3 d-none ">
                                                <label class="form-label" for="concurrents">
                                                    une application mobile internet de vos principaux concurrents : <span
                                                        class="text-danger">*</span>
                                                </label>
                                            ...
                                            <div class="col-sm-6 col-md-10">
                                                <div class="form-group">
                                                    <label for="exemples-sites" class="form-label">
                                                        Exemples des applications mobile avec commentaire :
                                                    </label>
                                                    <textarea id="exemples-sites" class="form-control" name="sample_sites" rows="3"
                                                        placeholder="Ajoutez des exemples des application mobile que vous aimez avec des commentaires sur ce que vous aimez bien sur ces application (éléments, animation, couleurs, architecture d’informations, fonctionnalités, etc.)."></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-10">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="contraintes">
                                                        Contraintes (donner des exemples d'application mobile , dont vous
                                                        appréciez un élément) :
                                                    </label>
                                                    <textarea class="form-control" id="contraintes" name="constraints" rows="3"
                                                        placeholder="Veuillez fournir des exemples des applications mobile que vous appréciez et décrire les éléments que vous aimez."></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12 mb-3 d-none ai-content">
                                                        ...
                                                        <div class="radio-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="domaineNon" name="domain" value="Non"checked
                                                                            onchange="toggleNomDomaine()">
                                                                        <label class="form-check-label"
                                                        ...
                                                        <div class="radio-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="hebergementNon" name="hosting"checked
                                                                    ...
                                                                    <tr style="min-height: 50px;">
                                                                        ...
                                                                        <td class="align-items-center d-flex"
                                                                            ...
                                                                            @if ($item['el'] == 'typography')
                                                                                <textarea type="text" title="Indiquez les préférences de typographie pour votre application mobile"
                                                                                    placeholder="Indiquez les préférences de typographie pour votre application mobile" class="form-control d-none"
                                        ...
                                        <div class="col-6">
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="palette-couleurs" class="form-control" name="color_palette"
                                                            placeholder="Indiquez les couleurs souhaitées pour votre application mobile"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="exemples-sites" class="form-label">
                                                            Exemples d'application mobile avec commentaire :
                                                        </label>
                                                        <textarea id="exemples-sites" class="form-control" name="exemples_sites" rows="3"
                                                            placeholder="Ajoutez des exemples d'application mobile que vous aimez avec des commentaires sur ce que vous aimez bien sur ces applications mobile (éléments, animation, couleurs, architecture d’informations, fonctionnalités, etc.)."></textarea>
                                                    </div>
